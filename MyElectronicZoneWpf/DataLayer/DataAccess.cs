...
namespace MyElectronicZoneWpf.DataLayer
{
    public partial class DataAccess
    {
        ...
        public DataTable GetAllBrands()
        {
            ...
            //construct parameter
            //dbParameterList.Add(new SQLiteParameter("@ProjectId", id));
            string queryToUse = string.Format("SELECT Id, Name, Description, CreatedDate FROM tblBrandMaster WHERE IsActive = 1");
            return SQLHelper.GetSelectedValue(queryToUse, dbParameterList);
        }
        /// <summary>
        /// Insert/Update Stock
        ...
        public DataTable GetAllSalesPerson()
        {
            ...
            //construct parameter
            //dbParameterList.Add(new SQLiteParameter("@ProjectId", id));
            //string queryToUse = string.Format("SELECT Id, Title, Name, Contact, AlternateContact, Email, Address FROM tblSalePerson WHERE IsActive = 1");
